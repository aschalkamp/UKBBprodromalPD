...
BASE_DIR = '/scratch/c.c21013066/data/ukbiobank/'
...
SAMPLES_DIR = os.path.join(BASE_DIR, 'sample/withGP/noOsteo')
...
PHENOTYPE_DATASET_CSV_FILE_PATH = os.path.join(BASE_DIR, f'ukb{ID}.csv')
...
FAM_FILE_PATH = os.path.join(GENETICS_DIR, f'ukb{ID}_cal_chr1_v2_s123456.fam')
...
IMPUTATION_V3_SAMPLE_FILE_NAME_TEMPLATE = f'ukb{ID}_imp_chr%s_v3.sample'
...
KINSHIP_TABLE_FILE_PATH = os.path.join(GENETICS_DIR, f'ukb{ID}_rel_s654321.dat')
...
TMP_DIR_FOR_RAW_MARKER_LINKS = '/scratch/c.c21013066/work'
