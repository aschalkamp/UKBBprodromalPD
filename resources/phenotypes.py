...
def run_gpdiagnosis(codes):
    data = pd.read_csv('/scratch/c.c21013066/data/ukbiobank/record_level/gp_clinical.txt',nrows=None,sep='\t',encoding = "ISO-8859-1")
    ...
    for code in codes:
        ...
        df.to_csv(f'/scratch/c.c21013066/data/ukbiobank/record_level/{name}.csv',index=False)
